...
const Lost_deals = () => {
    return (
        <div className='p-6 bg-white flex flex-col gap-2 self-stretch flex-[1_0_0] items-start justify-between rounded-2xl'>
            <div>
                <div className='pb-4 text-xl font-semibold leading-normal tracking-[-0.2px]'>Lost Deals</div>
                <div className='flex items-center gap-2'>
                    <div className='text-5xl font-medium leading-normal tracking-[-0.2px]'>4%</div>
                ...
                <div className='text-[#454545] text-sm tracking-[-0.3px] leading-normal'>You closed 96 out of 100 deals</div>
            </div>
            <a href="#" className='flex items-center pt-4 cursor-pointer'>
                <div className='text-[#734A00] text-sm'>All Deals</div>
