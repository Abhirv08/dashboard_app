...
export default function Home() {
  ...
  return (
    <div className="relative md:flex gap-4 p-4 bg-[#F6F6F3] h-full md:h-screen w-full ">
      <div className="sidebar_container fixed md:static h-full  z-50"><Sidebar /></div>
      <div className="body_container flex flex-col gap-4 items-center overflow-y-auto ">
